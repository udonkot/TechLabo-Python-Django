...
SECRET_KEY = "django-insecure-tevxeke-$f7px7^%mh9fj!xah6swi*&!fz@6#)v7&p3t-2*%^f"
...
LOG_FILE_APP = os.environ.get("log_file_app")
LOG_FILE_DJANGO = os.environ.get("log_file_django")
